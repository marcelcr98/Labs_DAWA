...
var empleados_sse=_.chain(employeesCollection)
 ...
 var param_remplacer = require('./lib/replace');
 ...
 var resultado = param_remplacer.replace(objetivo, reemplazos[idioma]);
 ...
 if(typeof exports !== 'undefined'){
    ...
    if(typeof module !== 'undefined' && module.exports){
        exports = module.exports = param_remplacer;
    }

    exports.param_remplacer = param_remplacer;
 }else{
     ShadowRoot.param_remplacer = param_remplacer;
 }